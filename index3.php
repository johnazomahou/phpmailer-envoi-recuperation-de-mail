...
//    echo utf8_decode(imap_utf8(imap_fetchbody($mailbox,$mail->msgno,"1"))).'<br>';
//   echo utf8_decode(imap_utf8(imap_body($mailbox,$mail[81]->msgno))).'<br>';

// echo imap_qprint($mails[81]->subject);
